...
**Layer 3 — cmg-guard Plugin**：内核级输出拦截 + 步骤完整性检查。v1.3.0(17hooks+pre_tool_call+自披露闭环)——直接 patch SKILL.md 被内核拦截、断言须附证据、步骤没做完禁止 LLM 回复。
...
cmg-guard/      v1.3.0   Plugin — 17hooks硬拦截 + pre_tool_call阻断 + 自披露闭环
```
