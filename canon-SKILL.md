...
- [SOUL 激活模式](references/soul-activation-pattern.md) — 技能自激活的通用方案，可供其他 Skill 复用
- [推荐列表配置 schema](references/recommendations-config-schema.md) — config.json recommendations 字段完整 schema 和检测逻辑
