...
description: 三省引擎 (CMG) — 取自「吾日三省吾身」。v5.5.5 cmg-guard v1.3.0(17hooks+pre_tool_call+post_llm_call完成证据+外部来源验证+自披露闭环)。对外 role:guard stage:pre_action，内部三模块各自独立。
version: 5.5.5
role: guard
dependencies: [canon, guard, mnemonic]
_comment: "v5.5.5 cmg-guard v1.3.0(17hooks+pre_tool_call)。Canon v2.7.2 + Guard v4.8.3 + Mnemonic v3.5.3。skill-autoload v1.0.1 + cmg-guard v1.3.0。"
